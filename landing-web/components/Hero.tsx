      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 py-24 lg:grid-cols-2 lg:px-8 lg:py-32">
        ...
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-gray-400">
            Buy, sell and trade digital assets with a powerful platform
            designed for Indian crypto users.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link
              href="/markets"
              className="rounded-xl border border-white/10 bg-white/5 px-7 py-3.5 font-semibold text-white hover:bg-white/10"
            >
              Explore Markets
            </Link>
          </div>
        ...
        <div className="relative">
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-blue-900/20">
            ...
            <div className="mb-5 flex items-center justify-between">
              ...
              <span className="rounded-lg bg-green-400/10 px-3 py-2 text-sm text-green-400">
                +2.41%
              </span>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="rounded-xl bg-green-500 py-3 font-semibold text-white hover:bg-green-600">
                Buy
              </button>

              <button className="rounded-xl bg-red-500 py-3 font-semibold text-white hover:bg-red-600">
                Sell
              </button>
            </div>
