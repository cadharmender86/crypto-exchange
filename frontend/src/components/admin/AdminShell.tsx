        ...
        <div className="border-t border-slate-800/90 p-3">
          <div className="flex items-center gap-3 rounded-xl border border-slate-800 bg-[#0c1422] p-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs text-emerald-400">{isSuperAdmin ? "Super Admin" : "Administrator"}</div>
            </div>
        ...
        <header className="sticky top-0 z-20 flex h-[62px] items-center justify-between border-b border-slate-800/90 bg-[#070c16]/95 px-4 backdrop-blur lg:px-5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:block">
              ...
              <div className="text-[10px] text-slate-500">{isSuperAdmin ? "Super Admin" : "Administrator"}</div>
            </div>
        ...
        <div className="border-b border-slate-800/80 bg-[#09101c] px-3 py-2 lg:hidden">
          <div className="flex gap-2 overflow-x-auto">
            {visibleNav.map((item) => {
              ...
              return <Link key={`mobile-${item.label}`} href={item.href} className={`whitespace-nowrap rounded-lg border px-3 py-1.5 text-xs ${active ? "border-indigo-500/60 bg-indigo-600/90 text-white" : "border-slate-700 text-slate-300"}`}>{item.label}</Link>;
            })}
          </div>
        </div>
