...
export default function RbacManagement() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    {showCreate && <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4"><form onSubmit={createAdmin} className="w-full max-w-lg rounded-2xl border border-slate-700 bg-[#0d1422] p-6 shadow-2xl">
