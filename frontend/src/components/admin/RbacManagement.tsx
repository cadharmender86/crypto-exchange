...
export default function RbacManagement() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    ...
    {roleConfirmation && <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-sm"><div className="w-full max-w-lg rounded-2xl border border-slate-700 bg-[#0d1422] p-6 shadow-2xl">
      {roleConfirmationStep === 1 ? <>
        ...
        <div className="mt-5 rounded-xl border border-slate-700 bg-slate-950/60 p-4"><div className="text-xs uppercase tracking-wider text-slate-500">Administrator</div><div className="mt-1 font-semibold text-white">{roleConfirmation.admin.full_name}</div><div className="text-xs text-slate-500">{roleConfirmation.admin.email}</div><div className="mt-5 grid grid-cols-[1fr_auto_1fr] items-center gap-3"><div><div className="text-xs text-slate-500">Current role</div><div className="mt-1 font-semibold text-slate-300">{roleConfirmation.currentRole}</div></div><div className="text-lg text-cyan-400">→</div><div><div className="text-xs text-slate-500">New role</div><div className="mt-1 font-bold text-cyan-300">{roleConfirmation.newRole}</div></div></div></div>
        ...
        <h3 className="text-lg font-bold text-white">Final confirmation</h3><p className="mt-2 text-sm text-slate-400">This action will immediately change the administrator's role and access permissions.</p>
        <div className="mt-4 rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-sm"><div className="font-semibold text-amber-300">{roleConfirmation.admin.email}</div><div className="mt-2 text-slate-400">Current: <span className="font-semibold text-slate-200">{roleConfirmation.currentRole}</span></div><div className="mt-1 text-slate-400">New role: <span className="font-bold text-cyan-300">{roleConfirmation.newRole}</span></div></div>
