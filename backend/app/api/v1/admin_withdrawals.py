...
def _response(
    ...
    return AdminWithdrawalResponse(
        ...
        approved_by=withdrawal.approved_by_admin_id,
...
async def list_withdrawals(
    ...
    _: AdminUser = Depends(
        require_permission("WITHDRAWAL_READ")
    ),
...
async def approve_withdrawal(
    ...
    admin: AdminUser = Depends(
        require_permission("WITHDRAWAL_APPROVE")
    ),
    db: AsyncSession = Depends(get_db),
):
