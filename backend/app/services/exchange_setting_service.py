...
from app.repositories.exchange_setting_repository import (
...
class ExchangeSettingService:
    ...
    async def get_setting(
        ...
        result = await ExchangeSettingRepository.get_by_key(
            db,
            key,
        )
    ...
    async def list_settings(
        ...
        result = await ExchangeSettingRepository.list_all(db)
    ...
    async def setting_exists(
        ...
        return await ExchangeSettingRepository.exists(
            db,
            key,
        )
    ...
    async def create_setting(
        ...
        *,
        ...
        return await ExchangeSettingRepository.create(
            db,
            setting,
        )
    ...
    async def update_setting(
        ...
        *,
        ...
        return await ExchangeSettingRepository.update(
            db,
            setting,
        )
    ...
    async def delete_setting(
        ...
        await ExchangeSettingRepository.delete(
            db,
            setting,
        )
    ...
    async def list_public_settings(
        ...
        return await ExchangeSettingRepository.list_public_settings(
            db,
        )
