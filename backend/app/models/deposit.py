...
class Deposit(Base):
    """Blockchain deposit observed for a customer's deposit address.

    A deposit starts as PENDING. Balance crediting is deliberately handled by
    the later blockchain-confirmation phase so customer-facing code cannot
    self-credit funds without an external blockchain event.
    """
